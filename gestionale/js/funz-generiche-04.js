...
function rimuoviClasseDaElemento(el, classeDaRimuovere) {
    var stringaClassi = el.className;
    if (stringaClassi.indexOf(" " + classeDaRimuovere) >= 0)
        stringaClassi = stringaClassi.replace(" " + classeDaRimuovere, "");
    else if (stringaClassi.indexOf(classeDaRimuovere) >= 0)
        stringaClassi = stringaClassi.replace(classeDaRimuovere, "");
    el.className = stringaClassi;
}
