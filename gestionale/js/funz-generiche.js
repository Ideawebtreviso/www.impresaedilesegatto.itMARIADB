...
// esempio: all = "questa è la mia stringa completa da cui devo estrarre la parola lucagirol e nient'altro"
// paramsx = "parola "
// paramdx = 
/*function strip(all, paramsx, paramdx) {
    int i = all.indexof(paramsx) + paramsx.length;
}*/
