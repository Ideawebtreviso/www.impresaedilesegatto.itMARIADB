<%@ Page Title="" Language="C#" MasterPageFile="~/gestionale/MasterPage.master" AutoEventWireup="true" CodeFile="gestione-rapportini.aspx.cs" Inherits="gestionale_costi_gestione_rapportini" %>
    ...
    <br />
        ...
        <table style="border-collapse:collapse;" class="iwebTABELLA">
            <tr>
                ...
                <asp:Repeater ID="RepeaterGiorniHeader" runat="server" OnLoad="RepeaterGiorniHeader_Load">
                    <ItemTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        <td class="repeaterCellaPrimaColonna">
                            ...
                            <asp:Label ID="LabelCodice" runat="server" Text='<%# Eval("codice") %>' Visible="true" />

                            <asp:LinkButton ID="LinkButton1" runat="server" 
                                PostBackUrl='<%# "~/gestionale/costi/carica-rapportino.aspx?IDMANODOPERA=" + Eval("id") %>'>
                                ...
                                <td class="repeaterCella">
                                    ...
                                    <asp:Repeater ID="Repeater3" runat="server" OnPreRender="Repeater3_PreRender">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabelQuantitaOre" runat="server" Text='<%# Convert.ToInt32(Eval("quantita")) %>'
