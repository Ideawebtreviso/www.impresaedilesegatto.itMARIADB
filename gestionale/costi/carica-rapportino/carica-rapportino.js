function caricaRapportino_inserisci() {
    ...
    eseguiQuery = eseguiQuery && document.getElementById("ore").value != "" && parseFloat(document.getElementById("ore").value) > 0;
    if (eseguiQuery) {
        ...
        else if (parseFloat(document.getElementById("ore").value) <= 0)
