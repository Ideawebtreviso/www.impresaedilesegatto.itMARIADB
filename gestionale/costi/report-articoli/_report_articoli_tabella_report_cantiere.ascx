<%@ Control Language="C#" ClassName="_report_cantiere_tabella_report_cantiere" %>
    ...
    <table id="tabellaReportArticoli" class="iwebTABELLA iwebCHIAVE__costo.id">
        <thead>
            <tr>
...
<%--                    <div class="iwebFILTRO iwebFILTROMinoreDi iwebFILTROTIPOCAMPO_data iwebCAMPO_costo.datacosto">
                    ...
                    <div class="glyphicon glyphicon-filter iwebCliccabile" title="Filtra" 
        ...
        <tbody class="iwebNascosto">
            <tr>
                ...
                <td>
                    <span class="iwebCAMPO_cantiere.descrizione iwebDescrizione iwebTroncaCrtsAt_30"></span>
                </td>
                <td>
                ...
                <td>
                    <span class="iwebCAMPO_costo.sconto1 iwebQuantita"></span>
                </td>
                <td>
                    <span class="iwebCAMPO_costo.sconto2 iwebQuantita"></span>
                </td>
                <td>
        ...
        <tfoot>
                ...
                <td>
                    ...
                    <span class="iwebSQLSELECT iwebNascosto">
	                    <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
                          ...
                          + "FROM costo INNER JOIN cantiere ON cantiere.id = costo.idcantiere "
            ...
            <tr><td><div class="iwebTABELLAFooterPaginazione">
                ...
                <div class="iwebPAGESIZE"><select id="Select1DSVG0J" onchange="iwebTABELLA_FooterCambiaPageSize()"><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option><option value="10000">Tutti</option></select></div><div>righe</div><div>|</div>
    ...
    <span class="iwebSQLSELECT">
	    <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(@"
            SELECT cantiere.id as 'cantiere.id',
                   ...
                   IF (bollafattura.isfattura AND bollafattura.isddt = false, bolla.numero, bollafattura.numero) as 'numerobolla', 
                   IF (bollafattura.isfattura AND bollafattura.isddt = false, bollafattura.numero, '') as 'numerofattura', 
                   (bollafattura.isfattura AND bollafattura.isddt) as 'bollafattura.isfattura' 
            ...
            WHERE costofatturariferita.id is NULL AND 
                  (@dataDa = '' OR (bolla.databollafattura is null AND costo.datacosto >= @dataDa) OR bolla.databollafattura >= @dataDa) AND 
                  (@dataA = '' OR (bolla.databollafattura is null AND costo.datacosto < @dataA + INTERVAL 1 DAY) OR bolla.databollafattura < @dataA + INTERVAL 1 DAY)
") %></span> <%-- QUESTA QUERY È NOTO CHE CI METTE 5 SECONDI ESCLUSI I TOTALI --%>
<%--            WHERE costofatturariferita.id is NULL AND 
                (@dataDa = '' OR ((bolla.databollafattura is null AND costo.datacosto >= @dataDa) OR (bolla.databollafattura is not null AND bolla.databollafattura >= @dataDa))) AND 
                (@dataA = '' OR ((bolla.databollafattura is null AND costo.datacosto <= @dataA) OR (bolla.databollafattura is not null AND bolla.databollafattura <= @dataA))) --%>
