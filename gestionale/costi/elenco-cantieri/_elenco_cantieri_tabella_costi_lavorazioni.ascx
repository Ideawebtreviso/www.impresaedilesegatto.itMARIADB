<%@ Control Language="C#" ClassName="_elenco_cantieri_tabella_costi_lavorazioni" %>


<table id="tabellaCostiLavorazioni" class="iwebTABELLA iwebCHIAVE__costo.id iwebBIND__elementoConITab">
    <thead>
        <tr>
            ...
            <th class="commandHead">
                <%--<div class="glyphicon glyphicon-plus iwebCliccabile" title="Aggiungi" 
                    onclick="iwebTABELLA_AggiungiRigaInPopup('popupTabellaCostiLavorazioniInserimento');"></div>--%>
            </th>
    ...
    <tbody class="iwebNascosto">
        <tr>
            ...
            <td>
                <div class="iwebCliccabile glyphicon glyphicon-pencil" title="Modifica" onclick="iwebTABELLA_ModificaRigaInPopup('popupTabellaCostiLavorazioniModifica'); iwebTABELLA_SelezionaRigaComeUnica();"></div>
            ...
            <td>
                <div class="iwebCliccabile glyphicon glyphicon-trash" title="Elimina"
                    onclick="iwebTABELLA_SelezionaRigaComeUnica(); iwebBind('tabellaCostiLavorazioni');
                                iwebTABELLA_EliminaRigaInPopup('popupTabellaCostiLavorazioniElimina')"></div>
            </td><%-- Eliminazione --%>
        </tr>
    </tbody>
    ...
    <tfoot><%-- iwebPAGENUMBER, iwebTOTPAGINE, iwebPAGESIZE, iwebTOTRECORD sono di riferimento al js --%>
        ...
        <tr><td><div class="iwebTABELLAFooterPaginazione">
            ...
            <div class="iwebPAGESIZE"><select id="Selectcostilavorazioni" onchange="iwebTABELLA_FooterCambiaPageSize()"><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option><option value="10000">Tutti</option></select></div><div>righe</div><div>|</div>
...
<span class="iwebSQLSELECT">
	<span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
        ...
        + "WHERE costo.idcantiere = @idcantiere AND fornitore.tipofornitore = 'Lavorazione' "
    )%></span>
...
<%-- inserimento --%>
<div id="popupTabellaCostiLavorazioniInserimento" class="popup popupType2" style="display:none">
    <div>
        <div class="popupHeader">
            <div class="glyphicon glyphicon-remove iwebCliccabile r" onclick="chiudiPopupType2()" ></div>
            <div class="popupTitolo l">Inserisci nuova lavorazione</div>
            <div class="b"></div>
        </div>
        <div class="popupCorpo">
            <table>
                <tr>
                    <td>Prodotto</td>
                    <td>
                        <div class="iwebAUTOCOMPLETAMENTO" id="iwebAUTOCOMPLETAMENTOCostoLavorazioniInserimento">
                            ...
                            <span class="iwebSQLSELECT">
                                <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
                                    ...
                                    + "WHERE (fornitore.ragionesociale like @codice OR prodotto.descrizione like @codice) AND fornitore.tipofornitore = 'Lavorazione' "
                                    + "LIMIT 3"
                                ) %></span>
                                <span class="iwebPARAMETRO">@codice = like_iwebAUTOCOMPLETAMENTOCostoLavorazioniInserimento_getValore</span>
                            </span>
        ...
        <div class="popupFooter">
            ...
            <div class="btn btn-success" onclick="iwebTABELLA_ConfermaAggiungiRecordInPopup('popupTabellaCostiLavorazioniInserimento', 'tabellaCostiLavorazioni', '', true)">Inserisci</div>
            <span class="iwebSQLINSERT">
	            ...
	            <span class="iwebPARAMETRO">@idprodotto = popupTabellaCostiLavorazioniInserimento_findvalue_prodotto.id</span>
                ...
                <span class="iwebPARAMETRO">@quantita = popupTabellaCostiLavorazioniInserimento_findvalue_costo.quantita</span>
                <span class="iwebPARAMETRO">@prezzo = popupTabellaCostiLavorazioniInserimento_findvalue_costo.prezzo</span>
                <span class="iwebPARAMETRO">@datacosto = popupTabellaCostiLavorazioniInserimento_findvalue_costo.datacosto</span>
            </span>
        </div>
    </div>
</div>
...
<%-- modifica --%>
<div id="popupTabellaCostiLavorazioniModifica" class="popup popupType2" style="display:none">
    <div>
        <div class="popupHeader">
            <div class="glyphicon glyphicon-remove iwebCliccabile r" onclick="chiudiPopupType2()" ></div>
            <div class="popupTitolo l">Modifica anagrafica lavorazione</div>
            <div class="b"></div>
        </div>
        <div class="popupCorpo">
            ...
            <table>
                ...
                <tr>
                    <td>Prodotto</td>
                    <td>
                        <div class="iwebAUTOCOMPLETAMENTO" id="iwebAUTOCOMPLETAMENTOCostiLavorazioniModifica">
                            <span class="iwebNascosto">-1</span> <%-- numero rigaSelezionata --%>
                            ...
                            <span class="iwebSQLSELECT">
                                ...
                                <span class="iwebPARAMETRO">@codice = like_iwebAUTOCOMPLETAMENTOCostiLavorazioniModifica_getValore</span>
                            </span>
                            <div class="iwebAUTOCOMPLETAMENTO_risultatiRicerca"><%--RISULTATI RICERCA--%></div>
                        </div>
                    </td>
        ...
        <div class="popupFooter">
            <div class="btn btn-warning" onclick="chiudiPopupType2()" >Annulla</div>
            <div class="btn btn-success" onclick="iwebTABELLA_ConfermaModificaRigaInPopup('popupTabellaCostiLavorazioniModifica', 'tabellaCostiLavorazioni', 'prodotto.id, costo.quantita, costo.prezzo, costo.datacosto', 'costo.id', true);">Aggiorna</div>
            <span class="iwebSQLUPDATE">
                ...
                <span class="iwebPARAMETRO">@idprodotto = popupTabellaCostiLavorazioniModifica_findValue_prodotto.id</span>
                <span class="iwebPARAMETRO">@quantita = popupTabellaCostiLavorazioniModifica_findValue_costo.quantita</span>
                <span class="iwebPARAMETRO">@prezzo = popupTabellaCostiLavorazioniModifica_findValue_costo.prezzo</span>
                <span class="iwebPARAMETRO">@datacosto = popupTabellaCostiLavorazioniModifica_findValue_costo.datacosto</span>
                <span class="iwebPARAMETRO">@id = popupTabellaCostiLavorazioniModifica_findValue_costo.id</span>
            </span>
...
<%-- elimina --%>
<div id="popupTabellaCostiLavorazioniElimina" class="popup popupType2" style="display:none">
    <div>
        <div class="popupHeader">
            <div class="glyphicon glyphicon-remove iwebCliccabile r" onclick="chiudiPopupType2()" ></div>
            <div class="popupTitolo l">Eliminazione lavorazione, ricontrolla i dati</div>
            <div class="b"></div>
        </div>
        <div class="iwebTABELLA_ContenitoreParametri"></div>
        <div class="popupCorpo">
        ...
        <div class="popupFooter">
            <div class="btn btn-warning" onclick="chiudiPopupType2()" >Annulla</div>
            <div class="btn btn-danger" onclick="iwebTABELLA_ConfermaEliminaRigaInPopup('popupTabellaCostiLavorazioniElimina', 'tabellaCostiLavorazioni', true);">Elimina</div>
            <span class="iwebSQLDELETE">
                <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL("DELETE FROM costo WHERE id = @id") %></span>
                <span class="iwebPARAMETRO">@id = popupTabellaCostiLavorazioniElimina_findValue_costo.id</span>
            </span>
        </div>
    </div>
</div>
