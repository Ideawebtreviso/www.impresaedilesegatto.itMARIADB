<%@ Control Language="C#" ClassName="_elenco_cantieri_tabella_costi_servizi" %>


                <table id="tabellaCostiServizi" class="iwebTABELLA iwebCHIAVE__costo.id iwebBIND__elementoConITab">
                    <thead>
                        <tr>
                            ...
                            <th class="commandHead">
                                <%--<div class="glyphicon glyphicon-plus iwebCliccabile" title="Aggiungi" 
                                    onclick="iwebTABELLA_AggiungiRigaInPopup('popuptabellaCostiServiziInserimento');"></div>--%>
                            </th>
                    ...
                    <tbody class="iwebNascosto">
                        <tr>
                            ...
                            <td>
                                <div class="iwebCliccabile glyphicon glyphicon-pencil" title="Modifica" onclick="iwebTABELLA_ModificaRigaInPopup('popuptabellaCostiServiziModifica'); iwebTABELLA_SelezionaRigaComeUnica();"></div>
                            ...
                            <td>
                                <div class="iwebCliccabile glyphicon glyphicon-trash" title="Elimina"
                                    onclick="iwebTABELLA_SelezionaRigaComeUnica(); iwebBind('tabellaCostiServizi');
                                             iwebTABELLA_EliminaRigaInPopup('popupTabellaCostiServiziElimina')"></div>
                            </td><%-- Eliminazione --%>
                        </tr>
                    </tbody>
                    <tbody>
                    ...
                    <tfoot><%-- iwebPAGENUMBER, iwebTOTPAGINE, iwebPAGESIZE, iwebTOTRECORD sono di riferimento al js --%>
                        ...
                        <tr><td><div class="iwebTABELLAFooterPaginazione">
                            ...
                            <div class="iwebPAGESIZE"><select id="Select5tg55tg54qweasdasd" onchange="iwebTABELLA_FooterCambiaPageSize()"><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option><option value="10000">Tutti</option></select></div><div>righe</div><div>|</div>
                ...
                <span class="iwebSQLSELECT">
	                <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
                       ...
                       + "WHERE costo.idcantiere = @idcantiere AND fornitore.tipofornitore = 'Servizio' "
                    )%></span>
                ...
                <%-- inserimento --%>
                <div id="popuptabellaCostiServiziInserimento" class="popup popupType2" style="display:none">
                    <div>
                        <div class="popupHeader">
                            <div class="glyphicon glyphicon-remove iwebCliccabile r" onclick="chiudiPopupType2()" ></div>
                            <div class="popupTitolo l">Inserisci nuovo servizio</div>
                            <div class="b"></div>
                        </div>
                        <div class="popupCorpo">
                            <table>
                                <tr>
                                    <td>Prodotto</td>
                                    <td>
                                        <div class="iwebAUTOCOMPLETAMENTO" id="iwebAUTOCOMPLETAMENTOCostoServizioInserimento">
                                            ...
                                            <span class="iwebSQLSELECT">
                                                <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
                                                  ...
                                                  + "WHERE (fornitore.ragionesociale like @codice OR prodotto.descrizione like @codice) AND fornitore.tipofornitore = 'servizio' "
                                                  + "LIMIT 3"
                                                ) %></span>
                                                <span class="iwebPARAMETRO">@codice = like_iwebAUTOCOMPLETAMENTOCostoServizioInserimento_getValore</span>
                                            </span>
                        ...
                        <div class="popupFooter">
                            ...
                            <div class="btn btn-success" onclick="iwebTABELLA_ConfermaAggiungiRecordInPopup('popuptabellaCostiServiziInserimento', 'tabellaCostiServizi', '', true)">Inserisci</div>
                            <span class="iwebSQLINSERT">
	                            ...
	                            <span class="iwebPARAMETRO">@idprodotto = popuptabellaCostiServiziInserimento_findvalue_prodotto.id</span>
                                ...
                                <span class="iwebPARAMETRO">@quantita = popuptabellaCostiServiziInserimento_findvalue_costo.quantita</span>
                                <span class="iwebPARAMETRO">@prezzo = popuptabellaCostiServiziInserimento_findvalue_costo.prezzo</span>
                                <span class="iwebPARAMETRO">@datacosto = popuptabellaCostiServiziInserimento_findvalue_costo.datacosto</span>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <%-- modifica --%>
                <div id="popuptabellaCostiServiziModifica" class="popup popupType2" style="display:none">
                    <div>
                        <div class="popupHeader">
                            <div class="glyphicon glyphicon-remove iwebCliccabile r" onclick="chiudiPopupType2()" ></div>
                            <div class="popupTitolo l">Modifica anagrafica servizio</div>
                            <div class="b"></div>
                        </div>
                        <div class="popupCorpo">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>Prodotto</td>
                                    <td>
                                        <div class="iwebAUTOCOMPLETAMENTO" id="iwebAUTOCOMPLETAMENTOCostiServiziModifica">
                                            <span class="iwebNascosto">-1</span> <%-- numero rigaSelezionata --%>
                                            ...
                                            <span class="iwebSQLSELECT">
                                                ...
                                                <span class="iwebPARAMETRO">@codice = like_iwebAUTOCOMPLETAMENTOCostiServiziModifica_getValore</span>
                                            </span>
                                            <div class="iwebAUTOCOMPLETAMENTO_risultatiRicerca"><%--RISULTATI RICERCA--%></div>
                                        </div>
                                    </td>
                        ...
                        <div class="popupFooter">
                            <div class="btn btn-warning" onclick="chiudiPopupType2()" >Annulla</div>
                            <div class="btn btn-success" onclick="iwebTABELLA_ConfermaModificaRigaInPopup('popuptabellaCostiServiziModifica', 'tabellaCostiServizi', 'prodotto.id, costo.quantita, costo.prezzo, costo.datacosto', 'costo.id', true);">Aggiorna</div>
                            <span class="iwebSQLUPDATE">
                                ...
                                <span class="iwebPARAMETRO">@idprodotto = popuptabellaCostiServiziModifica_findValue_prodotto.id</span>
                                <span class="iwebPARAMETRO">@quantita = popuptabellaCostiServiziModifica_findValue_costo.quantita</span>
                                <span class="iwebPARAMETRO">@prezzo = popuptabellaCostiServiziModifica_findValue_costo.prezzo</span>
                                <span class="iwebPARAMETRO">@datacosto = popuptabellaCostiServiziModifica_findValue_costo.datacosto</span>
                                <span class="iwebPARAMETRO">@id = popuptabellaCostiServiziModifica_findValue_costo.id</span>
                            </span>
                ...
                <%-- elimina --%>
                <div id="popupTabellaCostiServiziElimina" class="popup popupType2" style="display:none">
                    <div>
                        <div class="popupHeader">
                            <div class="glyphicon glyphicon-remove iwebCliccabile r" onclick="chiudiPopupType2()" ></div>
                            <div class="popupTitolo l">Eliminazione servizio, ricontrolla i dati</div>
                            <div class="b"></div>
                        </div>
                        <div class="iwebTABELLA_ContenitoreParametri"></div>
                        <div class="popupCorpo">
                        ...
                        <div class="popupFooter">
                            <div class="btn btn-warning" onclick="chiudiPopupType2()" >Annulla</div>
                            <div class="btn btn-danger" onclick="iwebTABELLA_ConfermaEliminaRigaInPopup('popupTabellaCostiServiziElimina', 'tabellaCostiServizi', true);">Elimina</div>
                            <span class="iwebSQLDELETE">
                                <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL("DELETE FROM costo WHERE id = @id") %></span>
                                <span class="iwebPARAMETRO">@id = popupTabellaCostiServiziElimina_findValue_costo.id</span>
                            </span>
                        </div>
                    </div>
                </div>
