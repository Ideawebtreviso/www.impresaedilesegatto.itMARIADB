<%@ Control Language="C#" ClassName="_elenco_cantieri_tabella_bolle" %>
                ...
                <table id="tabellaBolle" class="iwebTABELLA iwebCHIAVE__bollafattura.id iwebBIND__elementoConITab">
                    ...
                    <tfoot><%-- iwebPAGENUMBER, iwebTOTPAGINE, iwebPAGESIZE, iwebTOTRECORD sono di riferimento al js --%>
                        ...
                        <tr>
                            ...
                            <td>
                                <span id="Span1" class="iwebTOTALE iwebUSAFILTRI iwebValuta"></span>
                                <%--<span class="iwebSQLTOTAL">bollafattura.importo</span>--%>
                                <span class="iwebSQLSELECT iwebNascosto">
	                                <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
                                         "SELECT bollafattura.importo as 'TOTALE'"
                                       + "FROM (bollafattura JOIN fornitore ON bollafattura.idfornitore = fornitore.id) "
                                       + "                   JOIN costo ON bollafattura.id = costo.idbollafattura "
                        ...
                        <tr><td><div class="iwebTABELLAFooterPaginazione">
                            ...
                            <div class="iwebPAGESIZE"><select id="Select2vgsdvfo8s9asdasd" onchange="iwebTABELLA_FooterCambiaPageSize()"><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option><option value="10000">Tutti</option></select></div><div>righe</div><div>|</div>
                ...
                <span class="iwebSQLSELECT">
	                <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
                       ...
                       + "WHERE bollafattura.isddt = true AND "
                       + "      bollafattura.isfattura = true AND "
                       + "      costo.idcantiere = @idcantiere AND "
                       + "      fornitore.tipofornitore = 'Materiale' "
                       + "GROUP BY bollafattura.numero" 
                       )%></span>
