<%@ Control Language="C#" ClassName="_elenco_cantieri_tabella_rapportini" %>
                ...
                <table id="tabellaRapportini" class="iwebTABELLA iwebCHIAVE__costo.id iwebBIND__elementoConITab">
                        ...
                        <tr>
                            ...
                            <th class="commandHead">
                                <%--<div class="glyphicon glyphicon-plus iwebCliccabile" title="Aggiungi" 
                                    onclick="iwebTABELLA_AggiungiRigaInPopup('popupTabellaRapportiniInserimento');"></div>--%>
                            </th>
                    ...
                    <tbody class="iwebNascosto">
                        <tr>
                            ...
                            <td>
                                <div class="iwebCliccabile glyphicon glyphicon-pencil" title="Modifica" onclick="iwebTABELLA_ModificaRigaInPopup('popupTabellaRapportiniModifica'); iwebTABELLA_SelezionaRigaComeUnica();"></div>
                            ...
                            <td>
                                <div class="iwebCliccabile glyphicon glyphicon-trash" title="Elimina"
                                    onclick="iwebTABELLA_SelezionaRigaComeUnica(); iwebBind('tabellaRapportini');
                                             iwebTABELLA_EliminaRigaInPopup('popupTabellaRapportiniElimina')"></div>
                            </td><%-- Eliminazione --%>
                        </tr>
                    </tbody>
                    <tbody>
                    ...
                    <tfoot><%-- iwebPAGENUMBER, iwebTOTPAGINE, iwebPAGESIZE, iwebTOTRECORD sono di riferimento al js --%>
                        ...
                        <tr><td><div class="iwebTABELLAFooterPaginazione">
                            ...
                            <div class="iwebPAGESIZE"><select id="Select6asdasdfq212asdasd" onchange="iwebTABELLA_FooterCambiaPageSize()"><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option><option value="10000">Tutti</option></select></div><div>righe</div><div>|</div>
                ...
                <span class="iwebSQLSELECT">
	                <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
                       ...
                       + "WHERE costo.idcantiere = @idcantiere AND fornitore.tipofornitore = 'Manodopera' "
                    )%></span>
                ...
                <%-- inserimento --%>
                <div id="popupTabellaRapportiniInserimento" class="popup popupType2" style="display:none">
                    <div>
                        <div class="popupHeader">
                            <div class="glyphicon glyphicon-remove iwebCliccabile r" onclick="chiudiPopupType2()" ></div>
                            <div class="popupTitolo l">Inserisci nuovo rapportino</div>
                            <div class="b"></div>
                        </div>
                        <div class="popupCorpo">
                            <table>
                                <tr>
                                    <td>Prodotto</td>
                                    <td>
                                        <div class="iwebAUTOCOMPLETAMENTO iwebCAMPO_prodotto.id" id="iwebAUTOCOMPLETAMENTORapportiniInserimento">
                                            ...
                                            <span class="iwebSQLSELECT">
                                                <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
                                                  ...
                                                  + "WHERE (fornitore.ragionesociale like @codice OR prodotto.descrizione like @codice) AND fornitore.tipofornitore = 'Manodopera' "
                                                  + "LIMIT 3"
                                                ) %></span>
                                                <span class="iwebPARAMETRO">@codice = like_iwebAUTOCOMPLETAMENTORapportiniInserimento_getValore</span>
                                            </span>
                        ...
                        <div class="popupFooter">
                            ...
                            <div class="btn btn-success" onclick="iwebTABELLA_ConfermaAggiungiRecordInPopup('popupTabellaRapportiniInserimento', 'tabellaRapportini', '', true)">Inserisci</div>
                            <span class="iwebSQLINSERT">
	                            ...
	                            <span class="iwebPARAMETRO">@idprodotto = popupTabellaRapportiniInserimento_findvalue_prodotto.id</span>
                                ...
                                <span class="iwebPARAMETRO">@quantita = popupTabellaRapportiniInserimento_findvalue_costo.quantita</span>
                                <span class="iwebPARAMETRO">@prezzo = popupTabellaRapportiniInserimento_findvalue_costo.prezzo</span>
                                <span class="iwebPARAMETRO">@datacosto = popupTabellaRapportiniInserimento_findvalue_costo.datacosto</span>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <%-- modifica --%>
                <div id="popupTabellaRapportiniModifica" class="popup popupType2" style="display:none">
                    <div>
                        <div class="popupHeader">
                            <div class="glyphicon glyphicon-remove iwebCliccabile r" onclick="chiudiPopupType2()" ></div>
                            <div class="popupTitolo l">Modifica anagrafica rapportino</div>
                            <div class="b"></div>
                        </div>
                        <div class="popupCorpo">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>Prodotto</td>
                                    <td>
                                        <div class="iwebAUTOCOMPLETAMENTO" id="iwebAUTOCOMPLETAMENTORapportiniModifica">
                                            <span class="iwebNascosto">-1</span> <%-- numero rigaSelezionata --%>
                                            ...
                                            <span class="iwebSQLSELECT">
                                                ...
                                                <span class="iwebPARAMETRO">@codice = like_iwebAUTOCOMPLETAMENTORapportiniModifica_getValore</span>
                                            </span>
                                            <div class="iwebAUTOCOMPLETAMENTO_risultatiRicerca"><%--RISULTATI RICERCA--%></div>
                                        </div>
                                    </td>
                        ...
                        <div class="popupFooter">
                            <div class="btn btn-warning" onclick="chiudiPopupType2()" >Annulla</div>
                            <div class="btn btn-success" onclick="iwebTABELLA_ConfermaModificaRigaInPopup('popupTabellaRapportiniModifica', 'tabellaCostiServizi', 'prodotto.id, costo.quantita, costo.prezzo, costo.datacosto', 'costo.id', true);">Aggiorna</div>
                            <span class="iwebSQLUPDATE">
                                ...
                                <span class="iwebPARAMETRO">@idprodotto = popupTabellaRapportiniModifica_findValue_prodotto.id</span>
                                <span class="iwebPARAMETRO">@quantita = popupTabellaRapportiniModifica_findValue_costo.quantita</span>
                                <span class="iwebPARAMETRO">@prezzo = popupTabellaRapportiniModifica_findValue_costo.prezzo</span>
                                <span class="iwebPARAMETRO">@datacosto = popupTabellaRapportiniModifica_findValue_costo.datacosto</span>
                                <span class="iwebPARAMETRO">@id = popupTabellaRapportiniModifica_findValue_costo.id</span>
                            </span>
                ...
                <%-- elimina --%>
                <div id="popupTabellaRapportiniElimina" class="popup popupType2" style="display:none">
                    <div>
                        <div class="popupHeader">
                            <div class="glyphicon glyphicon-remove iwebCliccabile r" onclick="chiudiPopupType2()" ></div>
                        ...
                        <div class="popupFooter">
                            <div class="btn btn-warning" onclick="chiudiPopupType2()" >Annulla</div>
                            <div class="btn btn-danger" onclick="iwebTABELLA_ConfermaEliminaRigaInPopup('popupTabellaRapportiniElimina', 'tabellaRapportini', true);">Elimina</div>
                            <span class="iwebSQLDELETE">
                                <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL("DELETE FROM costo WHERE id = @id") %></span>
                                <span class="iwebPARAMETRO">@id = popupTabellaRapportiniElimina_findValue_costo.id</span>
                            </span>
                        </div>
                    </div>
                </div>
