...
<div class="b"></div>
                        ...
                        <div>
                            ...
                            <div class="iwebSQLUPDATE">
	                            <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
                                    "UPDATE cantiere SET idcliente = @idcliente, codice = @codice, descrizione = @descrizione, stato = @stato "
                                  + "WHERE id = @id"
                                ) %></span>
                ...
                <div class="l">
                    ...
                    <span class="iwebSQLSELECT">
                        <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
                            "SELECT cliente.nominativo as 'cliente.nominativo', cliente.id as 'cliente.id', cantiere.id as 'cantiere.id', "
