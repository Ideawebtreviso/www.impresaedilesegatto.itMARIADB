...
public partial class gestionale_costi_gestione_rapportini : System.Web.UI.Page
{
    ...
    protected void RepeaterGiorniHeader_Load(object sender, EventArgs e)
    {
        ...
        MySqlConnection connection = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionStringMySQL"].ConnectionString);  connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionStringMySQL"].ConnectionString;
        connection.Open();
