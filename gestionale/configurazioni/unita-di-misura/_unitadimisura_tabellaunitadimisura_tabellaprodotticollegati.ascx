    ...
    <div class="iwebTABELLAWrapper width915 l">
        <table id="tabellaProdottiCollegati" class="iwebTABELLA iwebCHIAVE__prodotto.id">
            ...
            <tbody class="iwebNascosto">
                <tr>
                    ...
                    <td>
                        <span class="iwebCAMPO_prodotto.sconto1"></span>
                    </td>
                    <td>
                        <span class="iwebCAMPO_prodotto.sconto2"></span>
                    </td>
                </tr>
            </tbody>
            ...
            <tfoot><%-- iwebPAGENUMBER, iwebTOTPAGINE, iwebPAGESIZE,iwebTOTRECORD sono di riferimento al js --%>
                ...
                <tr><td><div class="iwebTABELLAFooterPaginazione">
                    ...
                    <div class="iwebPAGESIZE"><select id="Select1WDXGAS" onchange="iwebTABELLA_FooterCambiaPageSize()"><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option><option value="10000">Tutti</option></select></div><div>righe</div><div>|</div>
        ...
        <span class="iwebSQLSELECT">
	        <span class="iwebSQL"><%= IwebCrypter.iwebcsCriptaSQL(
              ...
              + "FROM prodotto "
              + "WHERE prodotto.idunitadimisura = @idunitadimisura"
            ) %></span>
