...
function elencoComputi_duplicaComputo() {
    ...
    var ricaricopercentuale = iwebValutaParametroAjax("popupTabellaComputiDuplicaRicaricoPercentuale_value");
    ...
    var jsonAsObject = {
        ...
        ricaricopercentuale: ricaricopercentuale == "" ? null : parseFloat(ricaricopercentuale) // double?
    };
