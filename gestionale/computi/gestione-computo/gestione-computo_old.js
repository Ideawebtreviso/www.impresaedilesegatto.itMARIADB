...
function gestioneComputo_popupTabellaVociInserimento_confermaInserimento(idPopupAssociato, idTabella) {
            ...
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                if (jsonRisultatoQuery[0].errore == null) {
                    ...
                    if (nomeNuovaSuddivisione != "") { // se è stata inserita una nuova divisione aggiorna i dll di tabella, modifica e inserimento
                        ...
                        // azzero il campo Nuova suddivisione dpoo l'inserimento
...
function gestioneComputo_iwebTABELLA_ConfermaAggiungiRecordInPopup(idPopupAssociato, idTabella, parametri, attesaRispostaServer, funzioneAFineEsecuzione) {
            ...
            xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    ...
                    if (jsonRisultatoQuery[0].errore == null) {
                        ...
                        // l'id della misura inserita è: jsonRisultatoQuery[0].risultato
                        var idVoce = document.getElementById("tabellaVoci").getElementsByTagName("body")[1].getElementsByClassName("iwebRigaSelezionata")[0].getElementsByClassName("iwebCAMPO_voce.id")[0].innerHTML;
...
function gestioneComputo_inserisciMisuraEAggiorna() {
    gestioneComputo_iwebTABELLA_ConfermaAggiungiRecordInPopup(
