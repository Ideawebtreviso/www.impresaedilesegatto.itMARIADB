<%@ Control Language="C#" ClassName="_stampa_computo_tabella_computo" %>
        ...
        <table id="tabellaComputi" class="iwebTABELLA iwebCHIAVE__computo.id">
            ...
            <tbody class="iwebNascosto">
                <tr>
                    ...
                    <td class="iwebNascosto">
                        ...
                        <%-- questo parametro serve per Condizioni ultima pagina offerta che porto in seguito modificabile in basse--%>
            ...
            <tfoot class="iwebNascosto"><%-- iwebPAGENUMBER, iwebTOTPAGINE, iwebPAGESIZE,iwebTOTRECORD sono di riferimento al js --%>
                ...
                <tr><td><div class="iwebTABELLAFooterPaginazione">
                    ...
                    <div class="iwebPAGESIZE"><select id="Select1SBHFL6Y" onchange="iwebTABELLA_FooterCambiaPageSize()"><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option><option value="10000">Tutti</option></select></div><div>righe</div><div>|</div>
